  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Wrench className="h-4 w-4" /> Tools</CardTitle>
            <CardDescription>Register tool surfaces and upstream config.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Author and activate ABAC rules for V0.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><FileText className="h-4 w-4" /> Receipts</CardTitle>
            <CardDescription>Tamper-evident audit trail with correlation IDs.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Run these steps to show end-to-end control plane behavior.</CardDescription>
        </CardHeader>
        <CardContent className="text-sm">
          <ol className="list-decimal pl-5 space-y-1">
            <li>Run <span className="code">make dev</span> then <span className="code">make seed</span>.</li>
            <li>Set tenant ID from seed output (sidebar: Set tenant).</li>
            <li>Invoke PEP: <span className="code">curl -H x-umbra-tenant-id:... http://localhost:8082/tool/demo</span></li>
