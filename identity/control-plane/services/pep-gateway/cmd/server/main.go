...
import (
	...
	"github.com/umbra-labs/agent-identity-control-plane/services/pep-gateway/internal/http-api"
)
...
func main() {
	...
	srv := &http.Server{
		Addr:              addr,
		Handler:           otelhttp.NewHandler(mux, "pep-gateway.http"),
